...
public class SeenChatActivity extends AppCompatActivity {
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        ...
        if (!permissionToRecordAccepted) SeenChatActivity.super.finish();
        if (!permissionToWriteAccepted) SeenChatActivity.super.finish();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_chat);
         userchoice_id = getIntent().getStringExtra("userchoice_id");
        ...
        mDatabaseRef.child("Users").child(chatUserChoice).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                if (!image.equals("default")) {
                    Picasso.with(SeenChatActivity.this).load(image).placeholder(R.drawable.com_facebook_profile_picture_blank_portrait).into(imageView);
                }
            }
...
//        final Uri uri = Uri.fromFile(new File(mFileName));
    ...
    private void loadMessage() {
        DatabaseReference messageRef = mDatabaseRef.child("messages").child(chatUserChoice).child(userchoice_id);
